...
if platform.system() == "Windows":
    import winsound
    def alert_beep():
        winsound.Beep(2000, 150)   # frequency, duration
else:
    # cross-platform sound (you must have playsound installed)
    from playsound import playsound
    def alert_beep():
        playsound("alert.wav")   # place an alert.wav file in same folder
